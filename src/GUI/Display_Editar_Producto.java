...
public class Display_Editar_Producto extends JPanel{
  GridBagConstraints con = new GridBagConstraints();
  Grafo grafo = new Grafo();

    public Display_Editar_Producto(Ventana ventana, Producto producto){
        ...
        JTextField inputNombre = new JTextField(producto.getNombre());
        ...
        JTextField inputDescripcion = new JTextField(producto.getDescripcion());
        ...
        JTextField inputPrecio = new JTextField(producto.getPrecio().toString());
        ...
        Boton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
              ...
              try {
                ...
                gestor.editarProducto(producto, productoEditado);
                JOptionPane.showMessageDialog(null, "Se editó el producto " + producto.getNombre() + ".", "Producto editado correctamente", JOptionPane.INFORMATION_MESSAGE);
