    ...
    public Display_Consulta_Rutas(Ventana ventana){
        ...
        check7.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(check7.isSelected()) check8.setEnabled(false);
                else check8.setEnabled(true);
        ...
        check8.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(check8.isSelected()) check7.setEnabled(false);
                else check7.setEnabled(true);
